...
ALTER TABLE payments DROP CONSTRAINT IF EXISTS payments_authorization_fingerprint_check;

ALTER TABLE payments DROP COLUMN IF EXISTS authorization_fingerprint;
